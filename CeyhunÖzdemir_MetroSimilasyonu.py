...
class Istasyon:
    ...
    def __lt__(self, other):            # Python hata vermemesi için
        if isinstance(other, Istasyon):
...
class MetroAgi:
    ...
    def en_az_aktarma_bul(self, baslangic_id: str, hedef_id: str) -> Optional[List[Istasyon]]: 
        ...
        while kuyruk:
            ...
            if (mevcut, mevcut_hat) in ziyaret_edildi:
                continue
            ziyaret_edildi.add((mevcut, mevcut_hat))
